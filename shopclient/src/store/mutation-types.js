...
export const RECEIVE_SHOPS = 'receive_shops'// 接收食品分类数组
...
export const INCREMENT_FOOD_COUNT = 'increment_food_count' // 增加商品的數量
export const DECREMENT_FOOD_COUNT = 'decrement_food_count' // 減少商品的數量
export const CLEAR_CART = 'clear_cart' // 清空购物车
export const SEARCH_SHOPS = 'search_shops' // 根据关键字搜索店铺
